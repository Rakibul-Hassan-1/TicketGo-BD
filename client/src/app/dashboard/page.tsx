...
import { CheckCircle2, Clock, Download, Loader2, Ticket } from "lucide-react";
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      <div className="text-right">
                        ...
                        <span
                          className={`text-xs px-2 py-0.5 rounded-full ${paymentColor[b.paymentStatus] || "bg-gray-100 text-gray-600"}`}
                        >
                          {b.paymentStatus}
                        </span>
                      </div>
